...
public class SSC_Physics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssc_physics);

        Toolbar toolbarSSC_Physics = findViewById(R.id.toolbarSSC_Physics);
        setSupportActionBar( toolbarSSC_Physics );
