...
public class HSC_HigherMath1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsc_higher_math1);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarHSC_higherMath1);
