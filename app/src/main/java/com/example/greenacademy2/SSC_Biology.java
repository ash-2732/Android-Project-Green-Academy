...
public class SSC_Biology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbarSSC_Biology = findViewById(R.id.toolbarSSC_Biology);
        setSupportActionBar( toolbarSSC_Biology );
        getSupportActionBar().setDisplayHomeAsUpEnabled( true );


        String video = "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/gTj2OWd5YnM?si=8D5MOE7Itv3Px4XK\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>";
