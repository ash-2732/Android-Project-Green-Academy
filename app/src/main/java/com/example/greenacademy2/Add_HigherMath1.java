...
public class Add_HigherMath1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_higher_math1);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarAdd_higherMath1);
