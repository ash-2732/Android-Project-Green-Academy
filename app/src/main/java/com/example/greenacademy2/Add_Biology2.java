...
public class Add_Biology2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_biology2);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarAdd_Biology2);
