...
public class HSC_Biology2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsc_biology2);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarHSC_Biology2);
