...
public class SSC_Chemistry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String video = "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/a1CFxcTP3yQ?si=tib4vdVDaI6RBW7i\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>";

        Toolbar toolbarSSC_Chemistry = findViewById(R.id.toolbarSSC_Chemistry);
        setSupportActionBar( toolbarSSC_Chemistry );
