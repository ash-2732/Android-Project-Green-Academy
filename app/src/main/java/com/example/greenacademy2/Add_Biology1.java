...
public class Add_Biology1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_biology1);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarAdd_Biology1);
