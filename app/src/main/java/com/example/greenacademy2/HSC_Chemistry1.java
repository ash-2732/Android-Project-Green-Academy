...
public class HSC_Chemistry1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsc_chemistry1);


        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarHSC_Chemistry1);
