...
public class Add_HigherMath2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_higher_math2);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarAdd_higherMath2);
