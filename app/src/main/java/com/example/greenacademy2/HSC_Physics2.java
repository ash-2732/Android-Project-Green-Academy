...
public class HSC_Physics2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsc_physics2);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarHSC_Physics2);
