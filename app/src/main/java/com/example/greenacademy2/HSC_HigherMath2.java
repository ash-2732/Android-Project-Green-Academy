...
public class HSC_HigherMath2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsc_higher_math2);

        Toolbar toolbarHSC_Physics = findViewById(R.id.toolbarHSC_higherMath2);
