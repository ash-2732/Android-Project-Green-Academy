...
public class Add_Physics1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_physics1);

        Toolbar toolbarHSC = findViewById(R.id.toolbarAdd_Physics1);
